        ...
        <div class="contents-inner contact-inner _confirm">
            ...
            <div class="contact-flow">
                <ol class="contact-flow-list">
                    ...
                    <li class="contact-flow-item">
                        <p class="_active"><span>完了</span></p>
                    </li>
                </ol>
                <p class="thanks-msg">
                    お問い合わせが完了しました。<br>
                    お問い合わせ頂きありがとうございました。<br>
                    折り返し、担当者よりご連絡いたしますので<br class="_sp-only">しばらくお待ちください。<br>
                    <br>
                    なお、ご入力いただいたメールアドレス宛に<br class="_sp-only">受付完了メールを送信しております。<br>
                    完了メールが届かない場合、<br class="_sp-only">処理が正常に行われていない可能性があります。<br>
                    たいへん恐れ入りますが、<br class="_sp-only">再度お問い合わせの手続きをお願い致します。
                </p>
            </div>
